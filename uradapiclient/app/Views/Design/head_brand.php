<div class="header-brand">
    <div class="nav-item no-hover">
        ...
        <h6 class="title">
            <span class="tag tag--dark text-success"> uRadApiClient</span><span class=" subtitle font-normal">
                Administração</span>
        </h6>
    </div>
    ...
    <div class="nav-right">
        <div class="nav-item has-sub toggle-hover" id="dropdown">
            ...
            <ul class="dropdown-menu dropdown-animated" role="menu">
                ...
                <li role="menu-item"><a href="<?php echo base_url();?>/public/users/<?php echo $token ?? '';?>">">Usuários</a></li>
                <?php } ?>
